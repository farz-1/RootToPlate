...
class RestaurantForm(forms.ModelForm):
    ...
    phoneNumber = forms.IntegerField(required=False, label='Phone number',widget=forms.TextInput(attrs={'placeholder':'Enter 0 to leave empty'}))
    notes = forms.CharField(required=False, widget=forms.Textarea(attrs={'rows': '2'}))
    numberOfBags = forms.IntegerField(required=False, label='Number of bags of food waste',widget=forms.NumberInput(attrs={'placeholder':'Enter 0 if unknown' }))
